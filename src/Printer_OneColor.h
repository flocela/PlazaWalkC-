...
public:
    ...
    void receiveAllDrops(std::unordered_map<SpotType, std::unordered_set<Drop>> setOfDropsPerType, std::vector<Box> boxes) override;

private:
    SDL_Renderer* _renderer;
    void print(std::unordered_map<SpotType, std::unordered_set<Drop>> dropsPerType, std::vector<Box> boxes);
