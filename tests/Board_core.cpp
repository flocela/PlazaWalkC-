...
TEST_CASE("Board_core::")
{
    ...
    SECTION("Verify changes to Board's Spots and that BoardListener receives those changes. Create a BoardListener which saves changes that are sent to it. Make changes to Board. Request that Board send changes to the BoardListener. Verify that the BoardListener received the changes.")
    {
