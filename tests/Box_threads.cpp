...
TEST_CASE("Two threads repeatedly try to change Box's level, but because of Box's unique_lock in upLevel(), one thread always waits for the other one to finish")
{
    Box box{0, 0, 2, 2};
