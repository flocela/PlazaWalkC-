...
TEST_CASE("getFuturePositions doesn't return any positions that are off the board. Current position is at the right edge of the board. getFuturePosition does not return a postion with an x of 20, that would be off the board.")
{
...
TEST_CASE("getFuturePositions doesn't return any positions that are off the board. Current position is at the left edge of the board. getFuturePosition does not return a position with an x of -1, that would be off the board.")
{
    // final y is at y = 10. Board is a 20x20 board.
    PositionManager_Down downPositionManager(10, 0, 19, 0, 19);
